...
// Déclaration de l'objet LiquidCrystal
	...
	B_Stepper moteur(6,7,8,9); // Object B_Stepper
#else
	...
	B_Stepper moteur(12,13,22,23);// Object B_Stepper
#endif
...
#define PAS         400  // Nombre de pas pour effectuer un tour complet
...
void revolution(bool sens); // Permet la rotation du moteur
void setSpeed(void);
...
bool detectionAppui(uint8_t pin){
	if(not digitalRead(pin)==true){
		delayMicroseconds(200);// Attente après chaque appui
